...
AR Path="/56EF633C/56EF7E95" Ref="#PWR69"  Part="1" 
F 0 "#PWR69" H 9100 5700 30  0001 C CNN
...
AR Path="/56EF633C/56EF7E9B" Ref="#PWR42"  Part="1" 
F 0 "#PWR42" H 3000 7000 30  0001 C CNN
...
AR Path="/56EF633C/56EF7EA1" Ref="#PWR62"  Part="1" 
F 0 "#PWR62" H 6550 5600 30  0001 C CNN
...
AR Path="/56EF633C/56EF7EA7" Ref="#PWR60"  Part="1" 
F 0 "#PWR60" H 6150 5600 30  0001 C CNN
...
AR Path="/56EF633C/56EF7EB5" Ref="#PWR44"  Part="1" 
F 0 "#PWR44" H 3300 6750 30  0001 C CNN
...
AR Path="/56EF633C/56EF7EBB" Ref="#PWR46"  Part="1" 
F 0 "#PWR46" H 3500 5450 30  0001 C CNN
...
AR Path="/56EF633C/56EF7EC1" Ref="#PWR50"  Part="1" 
F 0 "#PWR50" H 3950 5450 30  0001 C CNN
...
AR Path="/56EF633C/56EF7EC7" Ref="#PWR53"  Part="1" 
F 0 "#PWR53" H 4400 5450 30  0001 C CNN
...
AR Path="/56EF633C/56EF7ECD" Ref="#PWR57"  Part="1" 
F 0 "#PWR57" H 4850 5450 30  0001 C CNN
...
AR Path="/56EF633C/56EF7ED3" Ref="#PWR45"  Part="1" 
F 0 "#PWR45" H 3500 5000 30  0001 C CNN
...
AR Path="/56EF633C/56EF7ED9" Ref="#PWR49"  Part="1" 
F 0 "#PWR49" H 3950 5000 30  0001 C CNN
...
AR Path="/56EF633C/56EF7EDF" Ref="#PWR52"  Part="1" 
F 0 "#PWR52" H 4400 5000 30  0001 C CNN
...
AR Path="/56EF633C/56EF7EE5" Ref="#PWR56"  Part="1" 
F 0 "#PWR56" H 4850 5000 30  0001 C CNN
...
AR Path="/56EF633C/56EF7F53" Ref="#PWR37"  Part="1" 
F 0 "#PWR37" H 2150 5000 30  0001 C CNN
...
AR Path="/56EF633C/56EF7F59" Ref="#PWR39"  Part="1" 
F 0 "#PWR39" H 2550 5000 30  0001 C CNN
...
AR Path="/56EF633C/56EF7F5F" Ref="#PWR41"  Part="1" 
F 0 "#PWR41" H 2950 5000 30  0001 C CNN
...
AR Path="/56EF633C/56EF7F6D" Ref="#PWR58"  Part="1" 
F 0 "#PWR58" H 5750 5600 30  0001 C CNN
...
F 0 "#PWR68" H 8950 1750 30  0001 C CNN
...
AR Path="/56EF633C/56EFB661" Ref="#PWR66"  Part="1" 
F 0 "#PWR66" H 8100 2650 30  0001 C CNN
...
AR Path="/56EF633C/56EFB675" Ref="#PWR67"  Part="1" 
F 0 "#PWR67" H 8700 2850 30  0001 C CNN
...
U 1 1 56F0D1A6
P 1550 1500
F 0 "E1" H 1550 1367 50  0000 C CNN
F 1 "600" H 1550 1276 50  0000 C CNN
F 2 "IPC7351-Nominal:RESC3216X60" H 1550 1400 50  0001 C CNN
F 3 "" H 1550 1550 60  0000 C CNN
F 4 "BEAD SMD 600 @100MHz 2A [1206]" H 1550 1300 60  0001 C CNN "BOM"
	1    1550 1500
	1    0    0    -1  
$EndComp
$Comp
...
F 0 "C13" H 2087 1654 50  0000 R CNN
F 1 "4u7" H 2087 1745 50  0000 R CNN
F 2 "IPC7351-Nominal:CAPC1608X55" H 2200 1700 50  0001 C CNN
F 3 "" H 2190 1675 60  0000 C CNN
F 4 "CAP MLCC 4u7 10V ≥X5R 20% [0603]" H 3000 2250 60  0001 C CNN "BOM"
	1    2200 1700
	-1   0    0    1   
$EndComp
$Comp
...
AR Path="/56EF633C/56F0D1BD" Ref="#PWR38"  Part="1" 
F 0 "#PWR38" H 2200 1850 30  0001 C CNN
...
AR Path="/56EF633C/56F0D20B" Ref="#PWR61"  Part="1" 
F 0 "#PWR61" H 6250 1800 30  0001 C CNN
...
AR Path="/56EF633C/56F1B0FC" Ref="#PWR48"  Part="1" 
F 0 "#PWR48" H 3800 6550 30  0001 C CNN
...
AR Path="/56EF633C/56F1B10A" Ref="#PWR51"  Part="1" 
F 0 "#PWR51" H 4200 6550 30  0001 C CNN
...
U 1 1 56F0B953
P 4750 2000
F 0 "#PWR55" H 4750 2000 30  0001 C CNN
...
U 1 1 56F0BB1F
P 5900 2300
F 0 "#PWR59" H 5900 2300 30  0001 C CNN
...
U 1 1 56F0C397
P 4500 2550
F 0 "#PWR54" H 4500 2550 30  0001 C CNN
...
U 1 1 56F0A481
P 3650 2800
F 0 "#PWR47" H 3650 2800 30  0001 C CNN
...
F 0 "C12" H 2587 1604 50  0000 R CNN
F 1 "4u7" H 2587 1695 50  0000 R CNN
F 2 "IPC7351-Nominal:CAPC1608X55" H 2700 1650 50  0001 C CNN
F 3 "" H 2690 1625 60  0000 C CNN
F 4 "CAP MLCC 4u7 10V ≥X5R 20% [0603]" H 3500 2200 60  0001 C CNN "BOM"
	1    2700 1650
	-1   0    0    1   
$EndComp
Wire Wire Line
...
U 1 1 56F107AE
P 2700 1800
F 0 "#PWR40" H 2700 1800 30  0001 C CNN
...
F 0 "#PWR65" H 7650 2700 30  0001 C CNN
...
U 1 1 56FEC226
P 3100 1650
AR Path="/56FEC226" Ref="C?"  Part="1" 
AR Path="/56EF633C/56FEC226" Ref="C35"  Part="1" 
F 0 "C35" H 3213 1696 50  0000 L CNN
F 1 "100n" H 3213 1605 50  0000 L CNN
F 2 "IPC7351-Nominal:CAPC1005X55" H 3100 1650 50  0001 C CNN
F 3 "" H 3090 1625 60  0000 C CNN
F 4 "CAP MLCC 100n ≥X5R 10V 20% [0402]" H 3900 2200 60  0001 C CNN "BOM"
	1    3100 1650
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 56FEC5F1
P 3100 1800
F 0 "#PWR43" H 3100 1800 30  0001 C CNN
